...
$('#cell-box').on('complete', (e, result) => {
    setTimeout(() => {
        if ( result == 3) alert("인간 승!2");
        else if (result == 30) alert("컴퓨터 승!2");
        else if(count == 5) alert("비겼다!2");
    }, 500);
});
